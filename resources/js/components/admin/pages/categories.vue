...
<div>
     <div class="card bg-card">
        ...
        <div class='table-responsive card-body' v-if="this.categories.length">
        ...
        <h2 v-else class="alert text-center p-5 text-warning">NO CATEGORIES ADDED YET!!!!</h2>
        <div class="card-footer" v-if="this.categories.length">
        ...
        <!-- Delete Tag Modal -->
         <modal
            ...
            >
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bold">Delete Category</h4>
                    </div>
         ...
         <modal
            ...
            >
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bold">Delete Categories</h4>
                    </div>
        ...
        methods: {
            ...
            this.form.post('/addCategory')
             ...
             editCategory() {
                ...
                this.form.post(`/editCategory/${this.editable.id}`)
                    .then(() => this.$modal.hide('edit-category-modal'))
                    .then(() => this.getCategories());
             },
             deleteCategory() {
                 this.form.post(`/deleteCategory/${this.editable.id}`)
                    .then(() => this.$modal.hide('delete-category-modal'))
                    .then(() => this.getCategories());
             },
             deleteAllCategories() {
                 this.form.post('/deleteAllCategories')
